		...
		<form:form method="POST" commandName="jugador" action="${x}" cssClass="form-signin">	
			<div class="panel panel-default">
				<div class="panel-body">
					...
					<!-- nombre -->
					<fmt:message key='jugador.label.identifiquese' var="identifiquese" />
					<form:input path="nombre" cssClass="form-control"  placeholder="${identifiquese}" autofocus="true"  />
					<form:errors path="nombre" cssStyle="color: red" />

					<!-- idiomas -->
					<h4 class="form-signin-heading"><fmt:message key="idioma" /></h4>					 
					<form:select id="idioma" path="idioma" cssClass="form-control">
						<form:options items="${idiomas}" />
					</form:select>
					
					<!-- Submit -->
					<form:button id="btnEntrar" class="btn btn-lg btn-primary btn-block" ><fmt:message key="entrar" /></form:button>
